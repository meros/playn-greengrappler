...
public class LevelSelectScreen extends Screen {
	...
	Animation myBackground = Resource.getAnimation("data/images/level_select.bmp", 1);
	Animation mySelectedLevelBackground = Resource.getAnimation("data/images/selected_level_background.bmp", 6);
	...
	public void onDraw(Surface aBuffer) {
		...
		for (int i = 0; i < myParticles.size(); i++)
		{
			...
			aBuffer.drawLine(myParticles.get(i).myX, myParticles.get(i).myY,  myParticles.get(i).myX + 2, myParticles.get(i).myY, 1);
		}
